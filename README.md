...
Le suivi de lignes va consister en l'identification des bords de la routes, qui sont représenté par des lignes bleu, puis au calcul de la direction à prendre.
...
**Dans un second temps, nous allons déterminer la direction à prendre. voici les étapes :**

* On trouve l'angle de braquage basé sur les coordonnées des lignes en fonction de si on repère deux, une ou aucune ligne.
* On détermine la ligne de cap à partir de l'angle de braquage
